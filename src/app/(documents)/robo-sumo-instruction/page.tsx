    ...
    <section id="robot-sumo-full-info-block">
      <div className={`robot-sumo-full-info-block__text-block`}>
        ...
        <div className={`paragraph-box-2 p-b-item-2`}>
          ...
          <p> Зона змагань поділяється на 3 частини:</p>
          <ul>
        ...
        <div className={`paragraph-box-5 p-b-item-5`}>
          ...
          <p>Всі члени команд впродовж турніру мають дотримуватись принципів фейр-плей – морального обов’язку
            учасника, тренера та інших осіб, що залучені до змагання, строго дотримуватись правил та регламенту змагань.
          </p>
          
          <p>Принципи фейр-плей:</p>
          <ul>
        ...
        <div className={`paragraph-box p-b-item-10`}>
          ...
          <p> Робот має бути автономним. Тобто таким, що керується лише програмою. Будь-яке дистанційне керування
            роботом заборонено.
          </p>
          ...
          <p>Запуск робота дозволено або прямим запуском програми – натисканням кнопки на мікропроцесорному
            блоці, або
            за допомогою датчика дотику.
          </p>
          <div id={PARAGRAPHS[6].anchorId}/>
          <p>Кожна команда отримує реєстраційний номер. Номер розміщується на роботі для того, щоб журі та
            глядачі
        ...
        <div className={`paragraph-box p-b-item-11`}>
          ...
          <p>В конструкції робота можна використовувати тільки один мікропроцесорний блок (RCX, NXT, EV3, SPIKE).
          </p>
          ...
          <p>Заборонено використання будь-яких неоригінальних чи модифікованих (відламані, підрізані, зігнуті і
            т.і.)
            деталей LEGO.
          </p>
          ...
          <p>В конструкції роботів не можна використовувати гвинти, клеї, мотузки, гумки і т.д. для закріплення
            деталей між собою.
          </p>
          <div id={PARAGRAPHS[7].anchorId}/>
          <p>Заборонено використання будь-яких пристосувань, що дають роботу підвищену стійкість, наприклад ,
            створюють вакуумне середовище.
          </p>
          
          <p>Заборонено використовувати пристосування, що кидають що-небудь в робота-суперника або заплутують
            його.
          </p>
        </div>
        <div className={`paragraph-box p-b-item-12`}>
          ...
          <p>При перевірці на габарит учасник має представити всі рухливі елементи (якщо вони є) свого робота у
            всіх
            їх можливих позиціях.
          </p>
          <p>Вагові розміри до 1 кг.</p>
        ...
        <div className={`paragraph-box p-b-item-13`}>
          ...
          <p>У випадку виявлення невідповідності вимогам змагань під час проведення раунду суддя призначає
            команді
            штраф.
          </p>
        ...
        <div className={`paragraph-box p-b-item-14`}>
          ...
          <p>Поле виконано розміщене на пласкі поверхні(Наприклад столі). Поле являє собою біле коло діаметром 1 м
            з
        ...
        <div className={`paragraph-box p-b-item-15`}>
          ...
          <p>В залежності від способу визначення переможців турнір з Сумо автономних роботів складається з двох
            етапів:
          </p>
        ...
        <div className={`paragraph-box p-b-item-16`}>
          ...
          <p>Розподіл команд по групам здійснюється шляхом жеребкування.</p>
          
          <p>Групи в турнірній таблиці виглядають наступним чином:</p>
          
          <p>Таким чином ми розподілимо команди по верхній і нижній сідці. В верхній сідці розміщуються переможці
        ...
        <div className={`paragraph-box p-b-item-17`}>
          ...
          <p>Верхня сітка змагається між собою де отримується один переможець який попадає у фінал. Нижня сітка
            аналогічно.
          </p>
          <div id={PARAGRAPHS[13].anchorId}/>
          <p>Команди що програли у 1/2 фіналу зіграють між собою матч за третє місце.</p>
          
          <p>Команда, що програє в фіналі, отримує друге місце, а переможець стає переможцем змагань Сумо
            автономних
            роботів.
          </p>
        </div>
        ...
        <div className={`paragraph-box p-b-item-19`}>
          ...
          <p>Штрафи, що можуть призначатися команді-порушнику:</p>
          <ul>
          ...
          <p>Найсуворіші штрафи можуть одразу призначатися команді за порушення принципів фейр-плей (наприклад,
          ...
          <p>Якщо команда отримала дискваліфікацію з турніру, вона має негайно залишити зону змагань.</p>
        </div>
